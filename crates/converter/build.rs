...
const ENV_KEY: &str = "PRIMITIVO_CONVERTER_ID";
const DEFAULT_ID: &str = "87ReJzgQU1KDbRWRtGC1DTtxUZ6dE3MkcEx2a37fFySr";
...
fn main() {
    ...
    let out_file = out_dir.join("converter_program_id.rs");
